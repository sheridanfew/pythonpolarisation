...
name='C8_BTBT_cation_neut_inner0_outer4'
#For crystals here, all cubic and centred at centre
insize=0
#number of TVs in each dir central mol is from edge of inner region
outsize=4
mols_cen=['C8_BTBT_mola_cation_aniso_cifstruct_chelpg.xyz','C8_BTBT_molb_neut_aniso_cifstruct_chelpg.xyz']
mols_sur=['C8_BTBT_mola_neut_aniso_cifstruct_chelpg.xyz','C8_BTBT_molb_neut_aniso_cifstruct_chelpg.xyz']
