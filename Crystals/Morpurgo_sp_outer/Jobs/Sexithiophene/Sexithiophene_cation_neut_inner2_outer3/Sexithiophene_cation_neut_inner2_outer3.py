...
name='Sexithiophene_cation_neut_inner2_outer3'
#For crystals here, all cubic and centred at centre
insize=2
#number of TVs in each dir central mol is from edge of inner region
outsize=3
mols_cen=['sexithiophene_mola_cation_aniso_cifstruct_chelpg.xyz','sexithiophene_molb_neut_aniso_cifstruct_chelpg.xyz','sexithiophene_molc_neut_aniso_cifstruct_chelpg.xyz','sexithiophene_mold_neut_aniso_cifstruct_chelpg.xyz']
