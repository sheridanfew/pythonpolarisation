...
Pc = GetMolecule('../Molecules/./TIPS_Pc_from_cif_rm_extrachains___TIPS_Pc_cation_cifcoords_HF_6_31PLUSgSTAR_cifstruct_mul.xyz')
...
f = open('../Crystals/TIPS_Pc_cation_neutral_2013_06_20.csv', 'w')
f.write ("Crystal Struct\tCentre\tSurroundings\tSize\tEnergy\tUqq\tUqd\tUdd\tDipole Moment")
f.flush()
f.close()


# size given number of translation vectors in each direction from central Pc
...
#csv file
	...
	f = open('../Crystals/TIPS_Pc_cation_neutral_2013_06_20.csv', 'a')
...
#.dat for gnuplot
	...
	f = open('TIPS_cation_neutral_size_%s.dat' % size, 'w')
