...
ReadMoleculeType('../Molecules/./Rubrene_neut_aniso_w_connectivity_cifstruct_chelpg.xyz')
ReadMoleculeType('../Molecules/./Rubrene_anion_aniso_w_connectivity_cifstruct_chelpg.xyz')

centre='Rubrene_anion_aniso_w_connectivity_cifstruct_chelpg.xyz'
surroundings='Rubrene_neut_aniso_w_connectivity_cifstruct_chelpg.xyz'
		...
		for y in np.arange(-size,size+1,1):
			...
			for z in np.arange(-size,size+1,1):
				...
				if x == 0 and y == 0 and z == 0:
					#central mol
					mols[xlist][ylist].append(GetMolecule('../Molecules/./Rubrene_anion_aniso_w_connectivity_cifstruct_chelpg.xyz'))
					print 'xlist,ylist,zlist',xlist,ylist,zlist
					#flippedmol
					molsflip[xlist][ylist].append(GetMolecule('../Molecules/./Rubrene_neut_aniso_w_connectivity_cifstruct_chelpg.xyz'))
					#print mols
					...
					mols[xlist][ylist].append(GetMolecule('../Molecules/./Rubrene_neut_aniso_w_connectivity_cifstruct_chelpg.xyz'))
					#print mols
