# 12Tcation:PC71BM_cation_B3LYP_6_31gSTAR_opt_mul polarisation model. from files:
#12T_cation_B3LYP_6_31gSTAR_opt_mul.xyz
#PC71BM_cation_B3LYP_6_31gSTAR_opt_mul.xyz
...
ReadMoleculeType('../Molecules/./TIPS_Pc_from_cif_rm_extrachains___TIPS_Pc_cation_cifcoords_HF_6_31PLUSgSTAR_cifstruct_mul.xyz')

centre='TIPS_Pc_from_cif_rm_extrachains___TIPS_Pc_cation_cifcoords_HF_6_31PLUSgSTAR_cifstruct_mul.xyz'
...
f = open('../Crystals/TIPS_Pc_cation_neutral_2013_06_20_new.csv', 'w')
		...
		for y in np.arange(-size,size+1,1):
			...
			for z in np.arange(-size,size+1,1):
				...
				if x == 0 and y == 0 and z == 0:
					#central mol
					mols[xlist][ylist].append(GetMolecule('../Molecules/./TIPS_Pc_from_cif_rm_extrachains___TIPS_Pc_cation_cifcoords_HF_6_31PLUSgSTAR_cifstruct_mul.xyz'))
				else:
...
#csv file
	...
	f = open('../Crystals/TIPS_Pc_cation_neutral_2013_06_20_new.csv', 'a')
...
#_new.dat for gnuplot
	...
	f = open('TIPS_cation_neutral_size_%s_new.dat' % size, 'w')
