...
ReadMoleculeType('../Molecules/./TIPS_Pc_neutral_cifcoords_HF_6_31PLUSgSTAR_w_connectivity_mul_w_anisotropy.xyz')

centre='TIPS_Pc_neutral_cifcoords_HF_6_31PLUSgSTAR_w_connectivity_mul_w_anisotropy.xyz'
surroundings='TIPS_Pc_neutral_cifcoords_HF_6_31PLUSgSTAR_w_connectivity_mul_w_anisotropy.xyz'
		...
		for y in np.arange(-size,size+1,1):
			...
			for z in np.arange(-size,size+1,1):
				...
				if x == 0 and y == 0 and z == 0:
					#central mol
					mols[xlist][ylist].append(GetMolecule('../Molecules/./TIPS_Pc_neutral_cifcoords_HF_6_31PLUSgSTAR_w_connectivity_mul_w_anisotropy.xyz'))
				else:
...
#csv file
	...
	f = open('../Crystals/TIPS_Pc_neutral_neutral_2013_10_25_aniso.csv', 'a')
...
#_new.dat for gnuplot
	...
	f = open('TIPS_neutral_neutral_aniso_size_%s_new.dat' % size, 'w')
