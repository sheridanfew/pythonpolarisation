# 12Tcation:PC71BM_anion_B3LYP_6_31gSTAR_opt_mul polarisation model. from files:
...
ReadMoleculeType('../Molecules/./TIPS_Pc_from_cif_rm_extrachains___TIPS_Pc_anion_cifcoords_HF_6_31PLUSgSTAR_cifstruct_mul.xyz')

centre='TIPS_Pc_from_cif_rm_extrachains___TIPS_Pc_anion_cifcoords_HF_6_31PLUSgSTAR_cifstruct_mul.xyz'
...
f = open('../Crystals/TIPS_Pc_anion_neutral_2013_06_20.csv', 'w')
		...
		for y in np.arange(-size,size+1,1):
			...
			for z in np.arange(-size,size+1,1):
				...
				if x == 0 and y == 0 and z == 0:
					#central mol
					mols[xlist][ylist].append(GetMolecule('../Molecules/./TIPS_Pc_from_cif_rm_extrachains___TIPS_Pc_anion_cifcoords_HF_6_31PLUSgSTAR_cifstruct_mul.xyz'))
				else:
...
#csv file
	...
	f = open('../Crystals/TIPS_Pc_anion_neutral_2013_06_20.csv', 'a')
...
#.dat for gnuplot
	...
	f = open('TIPS_anion_neutral_size_%s.dat' % size, 'w')
