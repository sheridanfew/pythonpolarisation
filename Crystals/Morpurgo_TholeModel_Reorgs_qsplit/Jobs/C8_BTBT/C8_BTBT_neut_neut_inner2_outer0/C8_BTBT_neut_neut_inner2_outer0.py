...
name='C8_BTBT_neut_neut_inner2_outer0'
#For crystals here, all cubic and centred at centre
insize=2
#number of TVs in each dir central mol is from edge of inner region
outsize=0
state='neut'
mols_cen=['Morpurgo/C8_BTBT_mola_neut_nobonds_cifstruct_ESP.xyz','Morpurgo/C8_BTBT_molb_neutral_nobonds_cifstruct_ESP.xyz']
