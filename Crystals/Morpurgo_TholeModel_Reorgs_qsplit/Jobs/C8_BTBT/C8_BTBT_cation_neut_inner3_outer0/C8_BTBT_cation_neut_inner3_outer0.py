...
name='C8_BTBT_cation_neut_inner3_outer0'
#For crystals here, all cubic and centred at centre
insize=3
#number of TVs in each dir central mol is from edge of inner region
outsize=0
state='cation'
mols_cen=['Morpurgo/C8_BTBT_mola_cation_nobonds_cifstruct_ESP.xyz','Morpurgo/C8_BTBT_molb_neutral_nobonds_cifstruct_ESP.xyz']
