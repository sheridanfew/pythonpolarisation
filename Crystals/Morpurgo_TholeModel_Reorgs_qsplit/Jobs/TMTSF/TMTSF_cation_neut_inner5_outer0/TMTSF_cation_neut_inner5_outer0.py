...
name='TMTSF_cation_neut_inner5_outer0'
#For crystals here, all cubic and centred at centre
insize=5
#number of TVs in each dir central mol is from edge of inner region
outsize=0
state='cation'
mols_cen=['Morpurgo/TMTSF_mola_cation_nobonds_cifstruct_ESP.xyz']
mols_sur=['Morpurgo/TMTSF_mola_neutral_nobonds_cifstruct_ESP.xyz']
mols_outer=['Morpurgo/TMTSF_mola_neutral_nobonds_cifstruct_ESP.xyz']
