...
outsize=0
state='cation'
mols_cen=['Morpurgo/sexithiophene_wH_mola_cation_nobonds_cifstruct_ESP.xyz','Morpurgo/sexithiophene_wH_molb_neutral_nobonds_cifstruct_ESP.xyz','Morpurgo/sexithiophene_wH_molc_neutral_nobonds_cifstruct_ESP.xyz','Morpurgo/sexithiophene_wH_mold_neutral_nobonds_cifstruct_ESP.xyz']
...
prot_neut_cry().ModifyPolarizabilityCry(jmtype='TholeExp', fittype='empirical')
...
jm = JMatrix(jmtype='TholeExp', fittype='empirical')
