...
name='Sexithiophene_neut_neut_inner4_outer0'
#For crystals here, all cubic and centred at centre
insize=4
#number of TVs in each dir central mol is from edge of inner region
outsize=0
state='neut'
mols_cen=['Morpurgo/sexithiophene_wH_mola_neut_nobonds_cifstruct_ESP.xyz','Morpurgo/sexithiophene_wH_molb_neutral_nobonds_cifstruct_ESP.xyz','Morpurgo/sexithiophene_wH_molc_neutral_nobonds_cifstruct_ESP.xyz','Morpurgo/sexithiophene_wH_mold_neutral_nobonds_cifstruct_ESP.xyz']
