...
name='Pentacene_anion_neut_inner6_outer0'
#For crystals here, all cubic and centred at centre
insize=6
#number of TVs in each dir central mol is from edge of inner region
outsize=0
state='anion'
mols_cen=['Morpurgo/Pentacene_mola_anion_nobonds_cifstruct_ESP.xyz','Morpurgo/Pentacene_molb_neutral_nobonds_cifstruct_ESP.xyz']
