...
name='Pentacene_cation_neut_inner4_outer0'
#For crystals here, all cubic and centred at centre
insize=4
#number of TVs in each dir central mol is from edge of inner region
outsize=0
state='cation'
mols_cen=['Morpurgo/Pentacene_mola_cation_nobonds_cifstruct_ESP.xyz','Morpurgo/Pentacene_molb_neutral_nobonds_cifstruct_ESP.xyz']
