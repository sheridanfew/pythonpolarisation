...
name='PDIFCN2_cation_neut_inner0_outer0'
#For crystals here, all cubic and centred at centre
insize=0
#number of TVs in each dir central mol is from edge of inner region
outsize=0
state='cation'
mols_cen=['Morpurgo/PDIFCN2_cation_nobonds_cifstruct_ESP.xyz']
mols_sur=['Morpurgo/PDIFCN2_neutral_nobonds_cifstruct_ESP.xyz']
mols_outer=['Morpurgo/PDIFCN2_neutral_nobonds_cifstruct_ESP.xyz']
