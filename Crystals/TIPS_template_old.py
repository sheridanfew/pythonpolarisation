...
Pc = GetMolecule('../Molecules/./TIPS_Pc_from_cif_rm_extrachains___TIPS_Pc_neutral_cifcoords_HF_6_31PLUSgSTAR_cifstruct_mul.xyz')

centre='TIPS_Pc_from_cif_rm_extrachains___TIPS_Pc_neutral_cifcoords_HF_6_31PLUSgSTAR_cifstruct_mul'
...
f = open('../Crystals/TIPS_Pc_neutral_neutral_2013_06_18.csv', 'w')
...
#	mols[((size+1)/2)-1][((size+1)/2)-1][((size+1)/2)-1]().__del__
	E0 = np.matrix([0.,0.,0.])
...
#csv file
	...
	f = open('../Crystals/TIPS_Pc_neutral_neutral_2013_06_18.csv', 'a')
...
#.dat for gnuplot
	...
	f = open('TIPS_size_%s.dat' % size, 'w')
