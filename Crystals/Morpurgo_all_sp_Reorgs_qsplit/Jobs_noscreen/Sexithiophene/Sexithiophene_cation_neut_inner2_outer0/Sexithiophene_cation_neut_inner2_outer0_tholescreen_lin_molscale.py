...
name='Sexithiophene_cation_neut_inner2_outer0'
#For crystals here, all cubic and centred at centre
insize=2
#number of TVs in each dir central mol is from edge of inner region
outsize=0
state='cation'
mols_cen=['sp_sexithiophene_mola_neut.xyz','sp_sexithiophene_molb_neut.xyz','sp_sexithiophene_molc_neut.xyz','sp_sexithiophene_mold_neut.xyz']
...
'''
		...
		elif self._jmtype == 'TholeExp' or self._jmtype == 'TholeExpIso': #See Duijnen et al. Table 7 for these values
			self._screenradius=kwargs.get('screenradius', None) 
			if self._fittype == 'mean':
...
Natoms=93.0
screenradius=1.6623/(Natoms**(1/3))
jm = JMatrix(jmtype='TholeLinAniso',screenradius=screenradius)
print strftime("%a, %d %b %Y %X +0000", gmtime())
print 'Calc dips:'
