...
outsize=0
state='anion'
mols_cen=['Sexithiophene_mola_anion_aniso_cifstruct_mul.xyz','Sexithiophene_molb_neut_aniso_cifstruct_mul.xyz','Sexithiophene_molc_neut_aniso_cifstruct_mul.xyz','Sexithiophene_mold_neut_aniso_cifstruct_mul.xyz']
