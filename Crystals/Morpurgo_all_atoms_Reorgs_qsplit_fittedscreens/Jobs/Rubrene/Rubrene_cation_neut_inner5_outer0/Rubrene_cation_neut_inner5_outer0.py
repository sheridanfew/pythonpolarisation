...
name='Rubrene_cation_neut_inner5_outer0'
#For crystals here, all cubic and centred at centre
insize=5
#number of TVs in each dir central mol is from edge of inner region
outsize=0
state='cation'
mols_cen=['Rubrene_mola_cation_aniso_cifstruct_mul.xyz','Rubrene_molb_neut_aniso_cifstruct_mul.xyz','Rubrene_molc_neut_aniso_cifstruct_mul.xyz','Rubrene_mold_neut_aniso_cifstruct_mul.xyz']
mols_sur=['Rubrene_mola_neut_aniso_cifstruct_mul.xyz','Rubrene_molb_neut_aniso_cifstruct_mul.xyz','Rubrene_molc_neut_aniso_cifstruct_mul.xyz','Rubrene_mold_neut_aniso_cifstruct_mul.xyz']
