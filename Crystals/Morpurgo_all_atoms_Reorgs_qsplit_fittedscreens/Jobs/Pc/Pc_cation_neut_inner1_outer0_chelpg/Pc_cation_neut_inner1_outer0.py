...
outsize=0
state='cation'
mols_cen=['Pentacene_mola_cation_aniso_cifstruct_chelpg.xyz','Pentacene_molb_neut_aniso_cifstruct_chelpg.xyz']
mols_sur=['Pentacene_mola_neut_aniso_cifstruct_chelpg.xyz','Pentacene_molb_neut_aniso_cifstruct_chelpg.xyz']
