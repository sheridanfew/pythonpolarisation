...
name='C60_cation_neut_inner0_outer0'
#For crystals here, all cubic and centred at centre
insize=0
#number of TVs in each dir central mol is from edge of inner region
outsize=0
state='cation'
mols_cen=['C60_mola_cation_aniso_cifstruct_mul.xyz','C60_molb_neut_aniso_cifstruct_mul.xyz','C60_molc_neut_aniso_cifstruct_mul.xyz','C60_mold_neut_aniso_cifstruct_mul.xyz']
mols_sur=['C60_mola_neut_aniso_cifstruct_mul.xyz','C60_molb_neut_aniso_cifstruct_mul.xyz','C60_molc_neut_aniso_cifstruct_mul.xyz','C60_mold_neut_aniso_cifstruct_mul.xyz']
