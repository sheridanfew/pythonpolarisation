...
name='C60_anion_neut_inner4_outer0'
#For crystals here, all cubic and centred at centre
insize=4
#number of TVs in each dir central mol is from edge of inner region
outsize=0
state='anion'
mols_cen=['C60_mola_anion_aniso_mul.xyz','C60_molb_neut_aniso_mul.xyz','C60_molc_neut_aniso_mul.xyz','C60_mold_neut_aniso_mul.xyz']
