mols_cen=['Rubrene_mola_STATE_aniso_cifstruct_chelpg.xyz','Rubrene_molb_neut_aniso_cifstruct_mul.xyz','Rubrene_molc_neut_aniso_cifstruct_mul.xyz','Rubrene_mold_neut_aniso_cifstruct_mul.xyz']
