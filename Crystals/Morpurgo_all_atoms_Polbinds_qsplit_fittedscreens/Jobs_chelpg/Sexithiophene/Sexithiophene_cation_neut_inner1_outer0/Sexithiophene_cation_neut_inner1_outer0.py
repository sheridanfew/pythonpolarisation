...
name='Sexithiophene_cation_neut_inner1_outer0'
#For crystals here, all cubic and centred at centre
insize=1
#number of TVs in each dir central mol is from edge of inner region
outsize=0
state='cation'
mols_cen=['Sexithiophene_mola_cation_aniso_cifstruct_chelpg.xyz','Sexithiophene_molb_neut_aniso_cifstruct_mul.xyz','Sexithiophene_molc_neut_aniso_cifstruct_mul.xyz','Sexithiophene_mold_neut_aniso_cifstruct_mul.xyz']
mols_sur=['Sexithiophene_mola_neut_aniso_cifstruct_chelpg.xyz','Sexithiophene_molb_neut_aniso_cifstruct_mul.xyz','Sexithiophene_molc_neut_aniso_cifstruct_mul.xyz','Sexithiophene_mold_neut_aniso_cifstruct_mul.xyz']
