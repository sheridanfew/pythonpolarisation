...
name='Rubrene_cation_neut_inner0_outer0'
#For crystals here, all cubic and centred at centre
insize=0
#number of TVs in each dir central mol is from edge of inner region
outsize=0
state='cation'
mols_cen=['Rubrene_mola_cation_aniso_cifstruct_chelpg.xyz','Rubrene_molb_neut_aniso_cifstruct_mul.xyz','Rubrene_molc_neut_aniso_cifstruct_mul.xyz','Rubrene_mold_neut_aniso_cifstruct_mul.xyz']
mols_sur=['Rubrene_mola_neut_aniso_cifstruct_chelpg.xyz','Rubrene_molb_neut_aniso_cifstruct_mul.xyz','Rubrene_molc_neut_aniso_cifstruct_mul.xyz','Rubrene_mold_neut_aniso_cifstruct_mul.xyz']
mols_outer=['sp_Rubrene_mola_neut.xyz','sp_Rubrene_molb_neut.xyz','sp_Rubrene_molc_neut.xyz','sp_Rubrene_mold_neut.xyz']

screenradius=2.5418033935
