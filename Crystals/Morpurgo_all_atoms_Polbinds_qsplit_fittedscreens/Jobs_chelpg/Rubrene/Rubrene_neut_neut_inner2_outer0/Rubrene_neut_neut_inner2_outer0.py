...
name='Rubrene_neut_neut_inner2_outer0'
#For crystals here, all cubic and centred at centre
insize=2
#number of TVs in each dir central mol is from edge of inner region
outsize=0
state='neut'
mols_cen=['Rubrene_mola_neut_aniso_cifstruct_chelpg.xyz','Rubrene_molb_neut_aniso_cifstruct_mul.xyz','Rubrene_molc_neut_aniso_cifstruct_mul.xyz','Rubrene_mold_neut_aniso_cifstruct_mul.xyz']
