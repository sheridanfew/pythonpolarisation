...
outsize=0
state='cation'
mols_cen=['C60_mola_cation_aniso_cifstruct_chelpg.xyz','C60_molb_neut_aniso_cifstruct_mul.xyz','C60_molc_neut_aniso_cifstruct_mul.xyz','C60_mold_neut_aniso_cifstruct_mul.xyz']
