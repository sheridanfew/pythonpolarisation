...
outsize=0
state='cation'
mols_cen=['C8_BTBT_mola_cation_aniso_cifstruct_chelpg.xyz','C8_BTBT_molb_neut_aniso_cifstruct_mul.xyz']
mols_sur=['C8_BTBT_mola_neut_aniso_cifstruct_chelpg.xyz','C8_BTBT_molb_neut_aniso_cifstruct_mul.xyz']
