...
centre='Pc_mola_neut_aniso_cifstruct_chelpg.xyz'
		...
		for y in np.arange(-size,size+1,1):
			...
			for z in np.arange(-size,size+1,1):
				...
				if x == 0 and y == 0 and z == 0:
					...
					#flippedmol
					molsb[xlist][ylist].append(GetMolecule('../Molecules/./%s' % surroundings))
					#print mols
				else:
					# Places molecule of this type if not in centre
					mols[xlist][ylist].append(GetMolecule('../Molecules/./%s' % centreb))
					#print mols
