...
ReadMoleculeType('../Molecules/./PENCEN_cation_aniso_w_connectivity_cifstruct_chelpg.xyz')
ReadMoleculeType('../Molecules/./PENCEN_aniso_w_connectivity_cifstruct_chelpg.xyz')

ReadMoleculeType('../Molecules/./PENCEN_2ndincell_aniso_w_connectivity_cifstruct_chelpg.xyz')
ReadMoleculeType('../Molecules/./PENCEN_cation_2ndincell_aniso_w_connectivity_cifstruct_chelpg.xyz')
...
centreb='PENCEN_cation_2ndincell_aniso_w_connectivity_cifstruct_chelpg.xyz'
		...
		for y in np.arange(-size,size+1,1):
			...
			for z in np.arange(-size,size+1,1):
				...
				if x == 0 and y == 0 and z == 0:
					#central mol
					mols[xlist][ylist].append(GetMolecule('../Molecules/./PENCEN_cation_aniso_w_connectivity_cifstruct_chelpg.xyz'))
					print 'xlist,ylist,zlist',xlist,ylist,zlist
					#flippedmol
					molsb[xlist][ylist].append(GetMolecule('../Molecules/./PENCEN_2ndincell_aniso_w_connectivity_cifstruct_chelpg.xyz'))
					#print mols
				else:
