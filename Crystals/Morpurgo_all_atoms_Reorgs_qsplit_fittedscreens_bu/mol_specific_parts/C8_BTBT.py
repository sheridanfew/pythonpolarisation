mols_cen=['C8_BTBT_mola_STATE_aniso_cifstruct_mul.xyz','C8_BTBT_mola_neut_aniso_cifstruct_mul.xyz']
mols_sur=['C8_BTBT_mola_neut_aniso_cifstruct_mul.xyz','C8_BTBT_mola_neut_aniso_cifstruct_mul.xyz']
