...
outsize=0
state='cation'
mols_cen=['Pentacene_mola_neut_aniso_mul.xyz','Pentacene_molb_neut_aniso_mul.xyz']
mols_sur=['Pentacene_mola_neut_aniso_mul.xyz','Pentacene_molb_neut_aniso_mul.xyz']
