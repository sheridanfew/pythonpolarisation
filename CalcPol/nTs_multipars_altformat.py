...
h = open('Polarisabilities_altformat_%s.csv' % basename, 'w')
h.write(basename)
h.write('\nLength')

for method in ['Lin','Exp']:
	for fit in ['components', 'mean', 'empirical']:
		h.write('\tLong_calpol_' + method + fit + '\tLong_pypol_' + method + fit + '\tLong_ratio_' + method + fit + '\tShort_calpol_' + method + fit + '\tShort_pypol_' + method + fit + '\tShort_ratio_' + method + fit + '\tFace_calpol_' + method + fit + '\tFace_pypol_' + method + fit + '\tFace_ratio_' + method + fit)
