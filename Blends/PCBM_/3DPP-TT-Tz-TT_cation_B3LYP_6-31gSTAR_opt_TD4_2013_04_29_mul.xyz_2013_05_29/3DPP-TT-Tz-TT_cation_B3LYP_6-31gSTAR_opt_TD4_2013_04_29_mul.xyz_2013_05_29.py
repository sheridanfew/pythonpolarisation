# PCBMEDITEDO: polarisation model. from files:
...
don = GetMolecule('../../../Molecules/./PCBM_EDITEDO_anion_mul.xyz')
donatomlist=[]
for atom in don():
...
f = open('../../../Blends/PCBM_/3DPP-TT-Tz-TT_cation_B3LYP_6-31gSTAR_opt_TD4_2013_04_29_mul.xyz_2013_05_29/3DPP-TT-Tz-TT_cation_B3LYP_6-31gSTAR_opt_TD4_2013_04_29_mul.xyz_2013_05_29.csv', 'w')
...
#csv file
			...
			f = open('../../../Blends/PCBM_/3DPP-TT-Tz-TT_cation_B3LYP_6-31gSTAR_opt_TD4_2013_04_29_mul.xyz_2013_05_29/3DPP-TT-Tz-TT_cation_B3LYP_6-31gSTAR_opt_TD4_2013_04_29_mul.xyz_2013_05_29.csv', 'a')
			f.write ('\nPCBMEDITEDO:\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s' % (regionnames[i],rotangle,distA,energyev,Uqq,Uqd,Udd,tot))
			f.flush()
			f.close()

#.dat for gnuplot

			f = open('PCBMEDITEDO__%s_%gdeg_%gA.dat' % (regionnames[i],rotangle,distA), 'w')
