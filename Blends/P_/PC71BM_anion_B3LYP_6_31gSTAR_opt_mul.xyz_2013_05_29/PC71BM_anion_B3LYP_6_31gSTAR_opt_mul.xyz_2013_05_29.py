...
f = open('../../../Blends/P_/PC71BM_anion_B3LYP_6_31gSTAR_opt_mul.xyz_2013_05_29/PC71BM_anion_B3LYP_6_31gSTAR_opt_mul.xyz_2013_05_29.csv', 'w')
...
#csv file
			...
			f = open('../../../Blends/P_/PC71BM_anion_B3LYP_6_31gSTAR_opt_mul.xyz_2013_05_29/PC71BM_anion_B3LYP_6_31gSTAR_opt_mul.xyz_2013_05_29.csv', 'a')
			f.write ('\n:\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s' % (regionnames[i],rotangle,distA,energyev,Uqq,Uqd,Udd,tot))
			f.flush()
			f.close()

#.dat for gnuplot

			f = open('__%s_%gdeg_%gA.dat' % (regionnames[i],rotangle,distA), 'w')
