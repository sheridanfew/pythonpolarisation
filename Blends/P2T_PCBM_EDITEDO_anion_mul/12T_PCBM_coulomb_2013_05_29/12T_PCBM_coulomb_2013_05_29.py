...
f = open('../../../Blends/P2T_PCBM_EDITEDO_anion_mul/12T_PCBM_coulomb_2013_05_29/12T_PCBM_coulomb_2013_05_29.csv', 'w')
...
#csv file
			...
			f = open('../../../Blends/P2T_PCBM_EDITEDO_anion_mul/12T_PCBM_coulomb_2013_05_29/12T_PCBM_coulomb_2013_05_29.csv', 'a')
			f.write ('\n12Tcation:PCBM_EDITEDO_anion_mul\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s' % (regionnames[i],rotangle,distA,energyev,Uqq,Uqd,Udd,tot))
			f.flush()
			f.close()

#.dat for gnuplot

			f = open('12Tcation_PCBM_EDITEDO_anion_mul_%s_%gdeg_%gA.dat' % (regionnames[i],rotangle,distA), 'w')
