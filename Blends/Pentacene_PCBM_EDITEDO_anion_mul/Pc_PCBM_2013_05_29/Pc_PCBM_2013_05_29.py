# Pentacenecation:PCBM_EDITEDO_anion_mul polarisation model. from files:
#Pentacene_cation_B3LYP_6-31gSTAR_opt_TD4_HF_6-31gSTAR_w_opt_2013_05_20.log
...
ReadMoleculeType('../../../Molecules/./Pentacene_cation_B3LYP_6-31gSTAR_opt_TD4_HF_6-31gSTAR_w_opt_2013_05_20.log')
don = GetMolecule('../../../Molecules/./Pentacene_cation_B3LYP_6-31gSTAR_opt_TD4_HF_6-31gSTAR_w_opt_2013_05_20.log')
donatomlist=[]
for atom in don():
...
f = open('../../../Blends/Pentacene_PCBM_EDITEDO_anion_mul/Pc_PCBM_2013_05_29/Pc_PCBM_2013_05_29.csv', 'w')
...
#csv file
			...
			f = open('../../../Blends/Pentacene_PCBM_EDITEDO_anion_mul/Pc_PCBM_2013_05_29/Pc_PCBM_2013_05_29.csv', 'a')
			f.write ('\nPentacenecation:PCBM_EDITEDO_anion_mul\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s' % (regionnames[i],rotangle,distA,energyev,Uqq,Uqd,Udd,tot))
			f.flush()
			f.close()

#.dat for gnuplot

			f = open('Pentacenecation_PCBM_EDITEDO_anion_mul_%s_%gdeg_%gA.dat' % (regionnames[i],rotangle,distA), 'w')
