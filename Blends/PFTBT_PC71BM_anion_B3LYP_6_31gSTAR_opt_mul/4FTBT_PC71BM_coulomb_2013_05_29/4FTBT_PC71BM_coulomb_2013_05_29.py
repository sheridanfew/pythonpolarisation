# 4FTBTcation:PC71BM_anion_B3LYP_6_31gSTAR_opt_mul polarisation model. from files:
#4FTBT_cation_B3LYP_6_31gSTAR_opt_mul.xyz
...
ReadMoleculeType('../../../Molecules/./4FTBT_cation_B3LYP_6_31gSTAR_opt_mul.xyz')
don = GetMolecule('../../../Molecules/./4FTBT_cation_B3LYP_6_31gSTAR_opt_mul.xyz')
donatomlist=[]
for atom in don():
...
f = open('../../../Blends/PFTBT_PC71BM_anion_B3LYP_6_31gSTAR_opt_mul/4FTBT_PC71BM_coulomb_2013_05_29/4FTBT_PC71BM_coulomb_2013_05_29.csv', 'w')
f.write ("System\tAlignment\tAngle\tDistance\tEnergy\tUqq\tUqd\tUdd\tDipole Moment")
f.flush()
f.close()

regionnames=['2T1', '2BT', '2T2', '3F', '3T1']
atomnos=np.array([[67, 69, 70, 71, 72, 73, 74],
[75, 76, 77, 78, 79, 80, 81, 82, 83, 84, 85],
[86, 87, 88, 89, 90, 91, 92],
[93, 94, 95, 96, 97, 98, 99, 100, 101, 102, 103, 104, 105, 106, 107, 108, 109, 110, 111, 112, 114],
...
#csv file
			...
			f = open('../../../Blends/PFTBT_PC71BM_anion_B3LYP_6_31gSTAR_opt_mul/4FTBT_PC71BM_coulomb_2013_05_29/4FTBT_PC71BM_coulomb_2013_05_29.csv', 'a')
			f.write ('\n4FTBTcation:PC71BM_anion_B3LYP_6_31gSTAR_opt_mul\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s' % (regionnames[i],rotangle,distA,energyev,Uqq,Uqd,Udd,tot))
			f.flush()
			f.close()

#.dat for gnuplot

			f = open('4FTBTcation_PC71BM_anion_B3LYP_6_31gSTAR_opt_mul_%s_%gdeg_%gA.dat' % (regionnames[i],rotangle,distA), 'w')
