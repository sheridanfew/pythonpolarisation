...
f = open('../../../Blends/PFTBT_PC71BM_anion_B3LYP_6_31gSTAR_opt_mul/4FTBT_PC71BM_coulomb_2013_05_30/4FTBT_PC71BM_coulomb_2013_05_30.csv', 'w')
...
#csv file
			...
			f = open('../../../Blends/PFTBT_PC71BM_anion_B3LYP_6_31gSTAR_opt_mul/4FTBT_PC71BM_coulomb_2013_05_30/4FTBT_PC71BM_coulomb_2013_05_30.csv', 'a')
			f.write ('\n4FTBTcation:PC71BM_anion_B3LYP_6_31gSTAR_opt_mul\t%s\t%s\t%s\t%s' % (regionnames[i],rotangle,distA,Uqq))
			f.flush()
			f.close()
