...
ReadMoleculeType('../../12T_mul.xyz')
octoT = GetMolecule('../../12T_mul.xyz')
ReadMoleculeType('../../PCBM_EDITEDO_anion_mul.xyz')
C60 = GetMolecule('../../PCBM_EDITEDO_anion_mul.xyz')
...
#	print C60()
	...
	for dist in distancerangeA:
		com=Molecule.get_com(C60())
		distbohr=np.divide(dist+com+3.3,0.529177)
