...
f = open('../../../Blends/P3TI_PC71BM_anion_B3LYP_6_31gSTAR_opt_mul/33TI_PC71BM_coulomb_2013_05_30/33TI_PC71BM_coulomb_2013_05_30.csv', 'w')
...
#			for atom in acc():
 #                               atom().move(disttest*dispversor[i])
			...
			thresholdmet = 'FALSE'
			for atom in acc():
				atom().move((distbohr-2)*dispversor[i])

			distmoved=distbohr-2
...
#csv file
			print 'Writing file'
			f = open('../../../Blends/P3TI_PC71BM_anion_B3LYP_6_31gSTAR_opt_mul/33TI_PC71BM_coulomb_2013_05_30/33TI_PC71BM_coulomb_2013_05_30.csv', 'a')
			f.write ('\n33TIcation:PC71BM_anion_B3LYP_6_31gSTAR_opt_mul\t%s\t%s\t%s\t%s' % (regionnames[i],rotangle,distA,Uqq))
			f.flush()
			f.close()
