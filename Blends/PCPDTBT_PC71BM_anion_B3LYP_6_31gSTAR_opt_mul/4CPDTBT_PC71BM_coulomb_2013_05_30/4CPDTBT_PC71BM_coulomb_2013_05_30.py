...
f = open('../../../Blends/PCPDTBT_PC71BM_anion_B3LYP_6_31gSTAR_opt_mul/4CPDTBT_PC71BM_coulomb_2013_05_30/4CPDTBT_PC71BM_coulomb_2013_05_30.csv', 'w')
...
regioniteration=np.arange(((len(atomnos) - 2 )/2),(((len(atomnos)+2) )/2),1)
...
#csv file
			...
			f = open('../../../Blends/PCPDTBT_PC71BM_anion_B3LYP_6_31gSTAR_opt_mul/4CPDTBT_PC71BM_coulomb_2013_05_30/4CPDTBT_PC71BM_coulomb_2013_05_30.csv', 'a')
			f.write ('\n4CPDTBTcation:PC71BM_anion_B3LYP_6_31gSTAR_opt_mul\t%s\t%s\t%s\t%s' % (regionnames[i],rotangle,distA,Uqq))
			f.flush()
			f.close()
