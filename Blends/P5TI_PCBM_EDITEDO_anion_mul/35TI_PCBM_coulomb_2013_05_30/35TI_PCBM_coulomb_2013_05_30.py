...
f = open('../../../Blends/P5TI_PCBM_EDITEDO_anion_mul/35TI_PCBM_coulomb_2013_05_30/35TI_PCBM_coulomb_2013_05_30.csv', 'w')
...
#csv file
			...
			f = open('../../../Blends/P5TI_PCBM_EDITEDO_anion_mul/35TI_PCBM_coulomb_2013_05_30/35TI_PCBM_coulomb_2013_05_30.csv', 'a')
			f.write ('\n35TIcation:PCBM_EDITEDO_anion_mul\t%s\t%s\t%s\t%s' % (regionnames[i],rotangle,distA,Uqq))
			f.flush()
			f.close()
