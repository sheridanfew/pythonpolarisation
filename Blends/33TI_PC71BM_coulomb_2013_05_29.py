...
f = open('../Blends/P3TI_PC71BM_anion_B3LYP_6_31gSTAR_opt_mul/33TI_PC71BM_coulomb_2013_05_29/33TI_PC71BM_coulomb_2013_05_29.csv', 'w')
...
#Place at correct Distance, places too close then pushes away until correct dist.
		...
		for distA in distrangeA:
			...
			energy = np.divide(energyev,27.211)
#			jm = get_jmat(E0=E0,cutoff=cut)

#csv file

			f = open('../Blends/P3TI_PC71BM_anion_B3LYP_6_31gSTAR_opt_mul/33TI_PC71BM_coulomb_2013_05_29/33TI_PC71BM_coulomb_2013_05_29.csv', 'a')
