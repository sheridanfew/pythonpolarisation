# 3DPPTT:PC71BM_anion_B3LYP_6_31gSTAR_opt_mul polarisation model. from files:
#3DPP_TT_Tz_TT_cation_B3LYP_6_31gSTAR_opt_TD4_2013_04_29_mul.xyz
...
ReadMoleculeType('../../../Molecules/./3DPP_TT_Tz_TT_cation_B3LYP_6_31gSTAR_opt_TD4_2013_04_29_mul.xyz')
don = GetMolecule('../../../Molecules/./3DPP_TT_Tz_TT_cation_B3LYP_6_31gSTAR_opt_TD4_2013_04_29_mul.xyz')
donatomlist=[]
for atom in don():
...
f = open('../../../Blends/PDPP_PC71BM_anion_B3LYP_6_31gSTAR_opt_mul/3DPP-TT-Tz-TT_PC71BM_coulomb_2013_05_29/3DPP-TT-Tz-TT_PC71BM_coulomb_2013_05_29.csv', 'w')
f.write ("System\tAlignment\tAngle\tDistance\tEnergy\tUqq\tUqd\tUdd\tDipole Moment")
f.flush()
f.close()

regionnames=['1Tz', '2fT1', '2DPP', '2fT2', '2Tz']
atomnos=np.array([[39, 40, 41, 42, 43, 44],
...
#csv file
			...
			f = open('../../../Blends/PDPP_PC71BM_anion_B3LYP_6_31gSTAR_opt_mul/3DPP-TT-Tz-TT_PC71BM_coulomb_2013_05_29/3DPP-TT-Tz-TT_PC71BM_coulomb_2013_05_29.csv', 'a')
			f.write ('\n3DPPTT:PC71BM_anion_B3LYP_6_31gSTAR_opt_mul\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s' % (regionnames[i],rotangle,distA,energyev,Uqq,Uqd,Udd,tot))
			f.flush()
			f.close()

#.dat for gnuplot

			f = open('3DPPTT_PC71BM_anion_B3LYP_6_31gSTAR_opt_mul_%s_%gdeg_%gA.dat' % (regionnames[i],rotangle,distA), 'w')
