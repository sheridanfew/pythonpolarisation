...
f = open('../../../Blends/PCDTBT_PCBM_EDITEDO_anion_mul/3CDTBT_PCBM_coulomb_2013_05_30/3CDTBT_PCBM_coulomb_2013_05_30.csv', 'w')
...
#csv file
			...
			f = open('../../../Blends/PCDTBT_PCBM_EDITEDO_anion_mul/3CDTBT_PCBM_coulomb_2013_05_30/3CDTBT_PCBM_coulomb_2013_05_30.csv', 'a')
			f.write ('\n3CDTBTcation:PCBM_EDITEDO_anion_mul\t%s\t%s\t%s\t%s' % (regionnames[i],rotangle,distA,Uqq))
			f.flush()
			f.close()
