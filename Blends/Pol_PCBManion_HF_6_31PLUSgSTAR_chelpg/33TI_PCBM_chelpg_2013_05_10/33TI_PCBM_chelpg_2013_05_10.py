# mol33TI:PCBManion_HF_6_31PLUSgSTAR_chelpg polarisation model. from files:
#mol_33TI_cation_B3LYP_6_31gSTAR_opt_BHandHLYP_6_31gSTAR_2013_04_29_chelpg.xyz
...
ReadMoleculeType('../../../Molecules/./mol_33TI_cation_B3LYP_6_31gSTAR_opt_BHandHLYP_6_31gSTAR_2013_04_29_chelpg.xyz')
don = GetMolecule('../../../Molecules/./mol_33TI_cation_B3LYP_6_31gSTAR_opt_BHandHLYP_6_31gSTAR_2013_04_29_chelpg.xyz')
donatomlist=[]
for atom in don():
...
f = open('../../../Blends/Pol_PCBManion_HF_6_31PLUSgSTAR_chelpg/33TI_PCBM_chelpg_2013_05_10/33TI_PCBM_chelpg_2013_05_10.csv', 'w')
...
#csv file
			...
			f = open('../../../Blends/Pol_PCBManion_HF_6_31PLUSgSTAR_chelpg/33TI_PCBM_chelpg_2013_05_10/33TI_PCBM_chelpg_2013_05_10.csv', 'a')
			f.write ('\nmol33TI:PCBManion_HF_6_31PLUSgSTAR_chelpg\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s' % (regionnames[i],rotangle,distA,energyev,Uqq,Uqd,Udd,tot))
			f.flush()
			f.close()

#.dat for gnuplot

			f = open('mol33TI_PCBManion_HF_6_31PLUSgSTAR_chelpg_%s_%gdeg_%gA.dat' % (regionnames[i],rotangle,distA), 'w')
