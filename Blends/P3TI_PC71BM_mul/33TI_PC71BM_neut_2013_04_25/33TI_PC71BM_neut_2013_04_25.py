# 33TIneut:PC71BMneut_mul polarisation model. from files:
#33TI_neutral_mul.xyz
#PC71BMneut_mul.xyz
...
ReadMoleculeType('../../../Molecules/./33TI_neutral_mul.xyz')
don = GetMolecule('../../../Molecules/./33TI_neutral_mul.xyz')
donatomlist=[]
for atom in don():
...
f = open('../../../Blends/P3TI_PC71BM_mul/33TI_PC71BM_neut_2013_04_25/33TI_PC71BM_neut_2013_04_25.csv', 'w')
...
#From JK Rotation 
		...
		ReadMoleculeType('../../../Molecules/./PC71BMneut_mul.xyz')
		acc = GetMolecule('../../../Molecules/./PC71BMneut_mul.xyz')
...
#csv file
			...
			f = open('../../../Blends/P3TI_PC71BM_mul/33TI_PC71BM_neut_2013_04_25/33TI_PC71BM_neut_2013_04_25.csv', 'a')
			f.write ('\n33TIneut:PC71BMneut_mul\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s' % (regionnames[i],rotangle,distA,energyev,Uqq,Uqd,Udd,tot))
			f.flush()
			f.close()

#.dat for gnuplot

			f = open('33TIneut_PC71BMneut_mul_%s_%gdeg_%gA.dat' % (regionnames[i],rotangle,distA), 'w')
