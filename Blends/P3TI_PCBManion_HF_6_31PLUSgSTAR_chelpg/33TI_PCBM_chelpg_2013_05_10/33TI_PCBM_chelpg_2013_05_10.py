# 33TIcation:PCBManion_HF_6_31PLUSgSTAR_chelpg polarisation model. from files:
#33TI_cation_B3LYP_6_31gSTAR_opt_BHandHLYP_6_31gSTAR_2013_04_29_chelpg.xyz
#PCBManion_HF_6_31PLUSgSTAR_chelpg.xyz
...
ReadMoleculeType('../../../Molecules/./33TI_cation_B3LYP_6_31gSTAR_opt_BHandHLYP_6_31gSTAR_2013_04_29_chelpg.xyz')
don = GetMolecule('../../../Molecules/./33TI_cation_B3LYP_6_31gSTAR_opt_BHandHLYP_6_31gSTAR_2013_04_29_chelpg.xyz')
donatomlist=[]
for atom in don():
...
f = open('../../../Blends/P3TI_PCBManion_HF_6_31PLUSgSTAR_chelpg/33TI_PCBM_chelpg_2013_05_10/33TI_PCBM_chelpg_2013_05_10.csv', 'w')
...
#From JK Rotation 
		...
		dispvec=np.zeros(shape=(6,3))
		dispvec[i]=(ROTMAT*np.matrix([[0., 0., 1. ]]).T).T

		ReadMoleculeType('../../../Molecules/./PCBManion_HF_6_31PLUSgSTAR_chelpg.xyz')
		acc = GetMolecule('../../../Molecules/./PCBManion_HF_6_31PLUSgSTAR_chelpg.xyz')
...
#csv file
			...
			f = open('../../../Blends/P3TI_PCBManion_HF_6_31PLUSgSTAR_chelpg/33TI_PCBM_chelpg_2013_05_10/33TI_PCBM_chelpg_2013_05_10.csv', 'a')
			f.write ('\n33TIcation:PCBManion_HF_6_31PLUSgSTAR_chelpg\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s' % (regionnames[i],rotangle,distA,energyev,Uqq,Uqd,Udd,tot))
			f.flush()
			f.close()

#.dat for gnuplot

			f = open('33TIcation_PCBManion_HF_6_31PLUSgSTAR_chelpg_%s_%gdeg_%gA.dat' % (regionnames[i],rotangle,distA), 'w')
