# 3DPPTT:PCBM_EDITEDO_anion_mul polarisation model. from files:
...
f = open('../../../Blends/PDPP_PCBM_EDITEDO_anion_mul/3DPP-TT-Tz-TT_PCBM_coulomb_2013_05_29/3DPP-TT-Tz-TT_PCBM_coulomb_2013_05_29.csv', 'w')
...
#csv file
			...
			f = open('../../../Blends/PDPP_PCBM_EDITEDO_anion_mul/3DPP-TT-Tz-TT_PCBM_coulomb_2013_05_29/3DPP-TT-Tz-TT_PCBM_coulomb_2013_05_29.csv', 'a')
			f.write ('\n3DPPTT:PCBM_EDITEDO_anion_mul\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s' % (regionnames[i],rotangle,distA,energyev,Uqq,Uqd,Udd,tot))
			f.flush()
			f.close()

#.dat for gnuplot

			f = open('3DPPTT_PCBM_EDITEDO_anion_mul_%s_%gdeg_%gA.dat' % (regionnames[i],rotangle,distA), 'w')
