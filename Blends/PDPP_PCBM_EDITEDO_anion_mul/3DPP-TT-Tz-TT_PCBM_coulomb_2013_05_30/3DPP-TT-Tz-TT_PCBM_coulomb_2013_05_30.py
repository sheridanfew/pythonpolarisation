...
f = open('../../../Blends/PDPP_PCBM_EDITEDO_anion_mul/3DPP-TT-Tz-TT_PCBM_coulomb_2013_05_30/3DPP-TT-Tz-TT_PCBM_coulomb_2013_05_30.csv', 'w')
...
#csv file
			...
			f = open('../../../Blends/PDPP_PCBM_EDITEDO_anion_mul/3DPP-TT-Tz-TT_PCBM_coulomb_2013_05_30/3DPP-TT-Tz-TT_PCBM_coulomb_2013_05_30.csv', 'a')
			f.write ('\n3DPPTT:PCBM_EDITEDO_anion_mul\t%s\t%s\t%s\t%s' % (regionnames[i],rotangle,distA,Uqq))
			f.flush()
			f.close()
