...
f = open('../../../Blends/P3TI_PCBM_EDITEDO_anion_mul/33TI_PCBM_coulomb_2013_05_30/33TI_PCBM_coulomb_2013_05_30.csv', 'w')
...
#csv file
			...
			f = open('../../../Blends/P3TI_PCBM_EDITEDO_anion_mul/33TI_PCBM_coulomb_2013_05_30/33TI_PCBM_coulomb_2013_05_30.csv', 'a')
			f.write ('\n33TIcation:PCBM_EDITEDO_anion_mul\t%s\t%s\t%s\t%s' % (regionnames[i],rotangle,distA,Uqq))
			f.flush()
			f.close()
