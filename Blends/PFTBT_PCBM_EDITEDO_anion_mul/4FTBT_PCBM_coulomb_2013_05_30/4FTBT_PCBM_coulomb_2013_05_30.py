...
f = open('../../../Blends/PFTBT_PCBM_EDITEDO_anion_mul/4FTBT_PCBM_coulomb_2013_05_30/4FTBT_PCBM_coulomb_2013_05_30.csv', 'w')
...
#csv file
			...
			f = open('../../../Blends/PFTBT_PCBM_EDITEDO_anion_mul/4FTBT_PCBM_coulomb_2013_05_30/4FTBT_PCBM_coulomb_2013_05_30.csv', 'a')
			f.write ('\n4FTBTcation:PCBM_EDITEDO_anion_mul\t%s\t%s\t%s\t%s' % (regionnames[i],rotangle,distA,Uqq))
			f.flush()
			f.close()
