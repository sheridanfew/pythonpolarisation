...
f = open('../../../Blends/P5TI_PC71BM_anion_B3LYP_6_31gSTAR_opt_mul/35TI_PC71BM_coulomb_2013_05_30/35TI_PC71BM_coulomb_2013_05_30.csv', 'w')
...
regioniteration=np.arange(((len(atomnos) - 6 )/2),(((len(atomnos)+6) )/2),1)
...
#csv file
			...
			f = open('../../../Blends/P5TI_PC71BM_anion_B3LYP_6_31gSTAR_opt_mul/35TI_PC71BM_coulomb_2013_05_30/35TI_PC71BM_coulomb_2013_05_30.csv', 'a')
			f.write ('\n35TIcation:PC71BM_anion_B3LYP_6_31gSTAR_opt_mul\t%s\t%s\t%s\t%s' % (regionnames[i],rotangle,distA,Uqq))
			f.flush()
			f.close()
