...
f = open('../../../Blends/P2T_PC71BM_anion_B3LYP_6_31gSTAR_opt_mul/12T_PC71BM_coulomb_2013_05_30/12T_PC71BM_coulomb_2013_05_30.csv', 'w')
...
#csv file
			...
			f = open('../../../Blends/P2T_PC71BM_anion_B3LYP_6_31gSTAR_opt_mul/12T_PC71BM_coulomb_2013_05_30/12T_PC71BM_coulomb_2013_05_30.csv', 'a')
			f.write ('\n12Tcation:PC71BM_anion_B3LYP_6_31gSTAR_opt_mul\t%s\t%s\t%s\t%s' % (regionnames[i],rotangle,distA,Uqq))
			f.flush()
			f.close()
