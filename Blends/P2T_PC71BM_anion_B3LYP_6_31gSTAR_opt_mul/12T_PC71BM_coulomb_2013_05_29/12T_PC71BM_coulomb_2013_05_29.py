...
f = open('../../../Blends/P2T_PC71BM_anion_B3LYP_6_31gSTAR_opt_mul/12T_PC71BM_coulomb_2013_05_29/12T_PC71BM_coulomb_2013_05_29.csv', 'w')
...
#csv file
			...
			f = open('../../../Blends/P2T_PC71BM_anion_B3LYP_6_31gSTAR_opt_mul/12T_PC71BM_coulomb_2013_05_29/12T_PC71BM_coulomb_2013_05_29.csv', 'a')
			f.write ('\n12Tcation:PC71BM_anion_B3LYP_6_31gSTAR_opt_mul\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s' % (regionnames[i],rotangle,distA,energyev,Uqq,Uqd,Udd,tot))
			f.flush()
			f.close()

#.dat for gnuplot

			f = open('12Tcation_PC71BM_anion_B3LYP_6_31gSTAR_opt_mul_%s_%gdeg_%gA.dat' % (regionnames[i],rotangle,distA), 'w')
