# 3CDTBTcation:PC71BM_anion_B3LYP_6_31gSTAR_opt_mul polarisation model. from files:
#3CDTBT_cation_B3LYP_6_31gSTAR_opt_mul.xyz
...
ReadMoleculeType('../../../Molecules/./3CDTBT_cation_B3LYP_6_31gSTAR_opt_mul.xyz')
don = GetMolecule('../../../Molecules/./3CDTBT_cation_B3LYP_6_31gSTAR_opt_mul.xyz')
donatomlist=[]
for atom in don():
...
f = open('../../../Blends/PCDTBT_PC71BM_anion_B3LYP_6_31gSTAR_opt_mul/3CDTBT_PC71BM_coulomb_2013_05_29/3CDTBT_PC71BM_coulomb_2013_05_29.csv', 'w')
f.write ("System\tAlignment\tAngle\tDistance\tEnergy\tUqq\tUqd\tUdd\tDipole Moment")
f.flush()
f.close()

regionnames=['1T2', '2CZ', '2T1', '2BT', '2T2']
...
#csv file
			...
			f = open('../../../Blends/PCDTBT_PC71BM_anion_B3LYP_6_31gSTAR_opt_mul/3CDTBT_PC71BM_coulomb_2013_05_29/3CDTBT_PC71BM_coulomb_2013_05_29.csv', 'a')
			f.write ('\n3CDTBTcation:PC71BM_anion_B3LYP_6_31gSTAR_opt_mul\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s' % (regionnames[i],rotangle,distA,energyev,Uqq,Uqd,Udd,tot))
			f.flush()
			f.close()

#.dat for gnuplot

			f = open('3CDTBTcation_PC71BM_anion_B3LYP_6_31gSTAR_opt_mul_%s_%gdeg_%gA.dat' % (regionnames[i],rotangle,distA), 'w')
