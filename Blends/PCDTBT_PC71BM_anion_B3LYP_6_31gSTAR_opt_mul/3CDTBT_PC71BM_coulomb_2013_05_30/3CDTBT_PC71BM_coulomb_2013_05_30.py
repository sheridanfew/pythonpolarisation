...
f = open('../../../Blends/PCDTBT_PC71BM_anion_B3LYP_6_31gSTAR_opt_mul/3CDTBT_PC71BM_coulomb_2013_05_30/3CDTBT_PC71BM_coulomb_2013_05_30.csv', 'w')
...
#csv file
			...
			f = open('../../../Blends/PCDTBT_PC71BM_anion_B3LYP_6_31gSTAR_opt_mul/3CDTBT_PC71BM_coulomb_2013_05_30/3CDTBT_PC71BM_coulomb_2013_05_30.csv', 'a')
			f.write ('\n3CDTBTcation:PC71BM_anion_B3LYP_6_31gSTAR_opt_mul\t%s\t%s\t%s\t%s' % (regionnames[i],rotangle,distA,Uqq))
			f.flush()
			f.close()
