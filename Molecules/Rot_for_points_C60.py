...
from Molecules.pol_TIPS_Pc_neut import *
pol_gauss=pol
q=-1
...
Importmol_gauss=('TIPS_Pc_anion_aniso_chelpg.xyz')
#Importmol_cif=('Pc_molb_anion_aniso_cifstruct_chelpg.xyz')
Importmol_cif=('TIPS_Pc_anion_aniso_cifstruct_chelpg.xyz')
...
print "''elname':'", molname, "','pos':Position([", centre_cif[0,0], ",", centre_cif[0,1], ",", centre_cif[0,2],"]), 'crg':", q, ", 'pol':Polarizability(noniso =[ [", pol_cif[0,0] ,",", pol_cif[0,1] ,",", pol_cif[0,2] ,"], [", pol_cif[1,0] ,",", pol_cif[1,1] ,",", pol_cif[1,2] ,"], [", pol_cif[2,0] ,",", pol_cif[2,1] ,",", pol_cif[2,2] ,"] ])}"



print "'{'elname':'C', 'pos':Position([ 0, 0, 1.38760702464127328237]), 'crg':-0.1361420, 'pol':Polarizability(noniso =[ [.00297427130379005355,0.0,0.0], [0.0,.06721397795356868408,0.0], [0.0,0.0,.19818954378783075002] ])}"
