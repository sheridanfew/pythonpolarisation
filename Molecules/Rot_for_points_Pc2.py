...
from Molecules.pol_PENCEN_neut_HF631PLUSGSTAR import *
pol_gauss=pol
...
Importmol_gauss=('Pc_mola_anion_aniso_chelpg.xyz')
#Importmol_cif=('Pc_molb_anion_aniso_cifstruct_chelpg.xyz')
Importmol_cif=('Pc_mola_anion_aniso_cifstruct_chelpg.xyz')
