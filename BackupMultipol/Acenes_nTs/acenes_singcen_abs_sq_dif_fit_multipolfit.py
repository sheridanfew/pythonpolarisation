...
def etatot( cut,C,H,single,pi):
	etalist=[abs_square_dif_fit('../Molecules/BENZENE_singcen_fit_aniso_no_charge.xyz',HFpol_BENZENE_singcen_fit_aniso,cut,C=C,H=H,single=single,pi=pi), abs_square_dif_fit('../Molecules/NAPHTA_singcen_fit_aniso_no_charge.xyz',HFpol_NAPHTA_singcen_fit_aniso,cut,C=C,H=H,single=single,pi=pi), abs_square_dif_fit('../Molecules/TETCEN_singcen_fit_aniso_no_charge.xyz',HFpol_TETCEN_singcen_fit_aniso,cut,C=C,H=H,single=single,pi=pi), abs_square_dif_fit('../Molecules/ANTCEN_singcen_fit_aniso_no_charge.xyz',HFpol_ANTCEN_singcen_fit_aniso,cut,C=C,H=H,single=single,pi=pi), abs_square_dif_fit('../Molecules/Pc_singcen_fit_aniso_no_charge.xyz',HFpol_Pc_singcen_fit_aniso,cut,C=C,H=H,single=single,pi=pi)]
	etatot=0
