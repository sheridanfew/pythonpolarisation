...
def etatot( cut,C,H,S,single,pi):
	etalist=[abs_square_dif_fit('../Molecules/thio_1T_neut_fit_aniso_no_charge.xyz',HFpol_thio_1T_neut_fit_aniso,cut,C=C,H=H,S=S,single=single,pi=pi), abs_square_dif_fit('../Molecules/thio_2T_neut_fit_aniso_no_charge.xyz',HFpol_thio_2T_neut_fit_aniso,cut,C=C,H=H,S=S,single=single,pi=pi), abs_square_dif_fit('../Molecules/thio_3T_neut_fit_aniso_no_charge.xyz',HFpol_thio_3T_neut_fit_aniso,cut,C=C,H=H,S=S,single=single,pi=pi), abs_square_dif_fit('../Molecules/thio_4T_neut_fit_aniso_no_charge.xyz',HFpol_thio_4T_neut_fit_aniso,cut,C=C,H=H,S=S,single=single,pi=pi), abs_square_dif_fit('../Molecules/thio_5T_neut_fit_aniso_no_charge.xyz',HFpol_thio_5T_neut_fit_aniso,cut,C=C,H=H,S=S,single=single,pi=pi), abs_square_dif_fit('../Molecules/thio_6T_neut_fit_aniso_no_charge.xyz',HFpol_thio_6T_neut_fit_aniso,cut,C=C,H=H,S=S,single=single,pi=pi), abs_square_dif_fit('../Molecules/thio_7T_neut_fit_aniso_no_charge.xyz',HFpol_thio_7T_neut_fit_aniso,cut,C=C,H=H,S=S,single=single,pi=pi), abs_square_dif_fit('../Molecules/thio_8T_neut_fit_aniso_no_charge.xyz',HFpol_thio_8T_neut_fit_aniso,cut,C=C,H=H,S=S,single=single,pi=pi), abs_square_dif_fit('../Molecules/BENZENE_singcen_fit_aniso_no_charge.xyz',HFpol_BENZENE_singcen_fit_aniso,cut,C=C,H=H,S=S,single=single,pi=pi), abs_square_dif_fit('../Molecules/NAPHTA_singcen_fit_aniso_no_charge.xyz',HFpol_NAPHTA_singcen_fit_aniso,cut,C=C,H=H,S=S,single=single,pi=pi), abs_square_dif_fit('../Molecules/TETCEN_singcen_fit_aniso_no_charge.xyz',HFpol_TETCEN_singcen_fit_aniso,cut,C=C,H=H,S=S,single=single,pi=pi), abs_square_dif_fit('../Molecules/ANTCEN_singcen_fit_aniso_no_charge.xyz',HFpol_ANTCEN_singcen_fit_aniso,cut,C=C,H=H,S=S,single=single,pi=pi), abs_square_dif_fit('../Molecules/Pc_singcen_fit_aniso_no_charge.xyz',HFpol_Pc_singcen_fit_aniso,cut,C=C,H=H,S=S,single=single,pi=pi)]
	etatot=0
