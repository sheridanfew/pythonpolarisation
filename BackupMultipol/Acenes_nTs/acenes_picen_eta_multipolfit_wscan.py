...
def etatot( cut,C,H,single,pi):
	etalist=[eta('../Molecules/BENZENE_picen_fit_aniso_no_charge.xyz',HFpol_BENZENE_picen_fit_aniso,cut,C=C,H=H,single=single,pi=pi), eta('../Molecules/NAPHTA_picen_fit_aniso_no_charge.xyz',HFpol_NAPHTA_picen_fit_aniso,cut,C=C,H=H,single=single,pi=pi), eta('../Molecules/TETCEN_picen_fit_aniso_no_charge.xyz',HFpol_TETCEN_picen_fit_aniso,cut,C=C,H=H,single=single,pi=pi), eta('../Molecules/ANTCEN_picen_fit_aniso_no_charge.xyz',HFpol_ANTCEN_picen_fit_aniso,cut,C=C,H=H,single=single,pi=pi), eta('../Molecules/Pc_picen_fit_aniso_no_charge.xyz',HFpol_Pc_picen_fit_aniso,cut,C=C,H=H,single=single,pi=pi)]
	etatot=0
