...
def etatot( screen,C,H,single,pi,dpi,double):
	etalist=[tholefit('../Molecules/py_Benzene_MOPAC.xyz',HFpol_Benzene_MOPAC,C=C,H=H,single=single,pi=pi,dpi=dpi,jmtype='TholeExp',screenradius=screen)]
...
#etatot(screen=2.1304, H=2.7927, C=8.6959, single=0.000001, double=0.000001,pi=0.000001,dpi=0.000001)

m=minuit.Minuit(etatot, screen=2.8990, H=1.3849, C=6.5780, single=0.000001, double=0.000001,pi=0.000001,dpi=0.0001,fix_H=True,fix_C=True,fix_single=True,fix_pi=True,fix_dpi=True,fix_double=True,limit_screen=(1.5,3.0))
m.printMode = 1
m.migrad()
