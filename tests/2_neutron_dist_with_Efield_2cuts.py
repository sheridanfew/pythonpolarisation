...
neutron2 =  GetMolecule('../Molecules/neutrontest.xyz')

#ReadMoleculeType('../Molecules/H2test.xyz')
#neutron=GetMolecule('../Molecules/H2test.xyz')

#ModifyPolarizability(neutron(), C=9.072879660383,H=0.100004083159,S=13.2644932888)
#	print "8T"
#	print neutron()
#	print "C60"

distancerange = np.arange(2., 4.1, 2.0)

for dist in distancerange:
	Molecule.place_at_d(neutron2(),np.matrix([0.,0.,dist]) )
	E0 = np.matrix([1.,0.,0.])
...
#		tot += dd
	...
	cut=1.1
	energy_nocut = get_energy(E0=E0,cutoff=cut)
	cut=6.1
	energy_cut = get_energy(E0=E0,cutoff=cut)	

	energydif = energy_cut - energy_nocut

	print 'dist, energydif'
	print dist, energydif
#	print "cut, dist, tot, energy, energyev"
#	print dist, tot, energy, energyev

#	energy = get_energy(E0=E0,cutoff=6.01)
