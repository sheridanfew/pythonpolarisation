...
#	etacalc=eta('../Molecules/6T_CONSTRAINED_neutral_no_charge.xyz',HFpol_6T_CONSTRAINED_neutral, c=c, h=h, s=s, n=n, cut=cut)
	abs_sq=abs_square_dif_fit('../Molecules/6T_CONSTRAINED_neutral_no_charge.xyz',HFpol_6T_CONSTRAINED_neutral, c=c, h=h, s=s, n=n, cut=cut)
	return etacalc

etacalc(c=10.0, h=1.0, s=10.0, n=5.155, cut=5.0)
